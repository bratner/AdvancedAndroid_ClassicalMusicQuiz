...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    private MediaSessionCompat initializeMediaSession() {
        MediaSessionCompat mediaSession = new MediaSessionCompat(this, "Classical Quiz");
        mediaSession.setFlags(MediaSessionCompat.FLAG_HANDLES_MEDIA_BUTTONS
                | MediaSessionCompat.FLAG_HANDLES_TRANSPORT_CONTROLS);
        mediaSession.setMediaButtonReceiver(null); //Pending intent as a param... very interesting
        PlaybackStateCompat.Builder playbackStateBuilder = new PlaybackStateCompat.Builder().setActions(
                        PlaybackStateCompat.ACTION_PAUSE |
                        PlaybackStateCompat.ACTION_PLAY |
                        PlaybackStateCompat.ACTION_PLAY_PAUSE |
                        PlaybackStateCompat.ACTION_SKIP_TO_PREVIOUS
                        );
        mPlaybackStateBuilder = playbackStateBuilder; //To be updated in player events
        mediaSession.setPlaybackState(playbackStateBuilder.build());

        mediaSession.setCallback(new QuizMediaSessionCallbacks());
        return mediaSession;
    }
    /**
    ...
    private class QuizMediaSessionCallbacks extends MediaSessionCompat.Callback {
        @Override
        public void onPlay() {
            mExoPlayer.setPlayWhenReady(true);
        }
